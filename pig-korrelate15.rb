...
class PigKorrelate15 < Formula
  homepage 'https://github.com/korrelate/pig'
  head 'https://github.com/korrelate/pig.git', :using => :git, :branch => "branch-0.15.1-korrelate"
  ...
  def install
    ...
    prefix.install ["pig-0.15.1-KORRELATE-core-h2.jar"]
  end
